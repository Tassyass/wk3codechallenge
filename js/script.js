    ...
    .then(data => {
        ...
        function populateFilmList(films) {
            films.forEach(film => {
                ...
                filmElement.innerHTML = `
                    ...
                    <p>Description: ${film.description}</p>
                    <p>Tickets Sold: ${film.tickets_sold} / Capacity: ${film.capacity}</p>
                    <button data-film='${JSON.stringify(film)}' class="view-details">View Details</button>
                `;
        ...
        filmList.addEventListener("click", (event) => {
            if (event.target.classList.contains("view-details")) {
                const selectedFilm = JSON.parse(event.target.getAttribute("data-film"));
        ...
        // Populate the film list with data from the server
        populateFilmList(data.films);
    })
